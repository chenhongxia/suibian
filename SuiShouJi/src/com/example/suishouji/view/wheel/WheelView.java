...
package com.example.suishouji.view.wheel;

import java.util.LinkedList;
import java.util.List;

import com.example.suishouji.R;
import com.example.suishouji.view.wheel.adapter.WheelViewAdapter;
...
public class WheelView extends View
{
	 ...
	 */
	private int[] SHADOWS_COLORS = new int[] { 0xccfffffb, 0x1Afffffb, 0xccfffffb };
	...
	{
		TextView t = (TextView) getItemView(currentItem);
		String s = t.getText().toString();
		TextPaint valuePaint = new TextPaint(Paint.ANTI_ALIAS_FLAG);
		valuePaint.setTextSize(t.getTextSize());
		canvas.drawText(s, getWidth() ,getItemHeight() , valuePaint);
	}
