...
public class CustomTimePicker extends TimePicker
{
    ...
    public CustomTimePicker(Context context, AttributeSet attrs)
    {
        ...
        try
        {
            ...
            selectionDividerField.set(hourNumberPicker, getResources().getDrawable(R.drawable.teacher_name_label));
            selectionDividerField.set(minuteNumberPicker, getResources().getDrawable(R.drawable.teacher_name_label));
            selectionDividerField.set(amPmNumberPicker, getResources().getDrawable(R.drawable.teacher_name_label));
        }
